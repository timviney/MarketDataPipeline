...
using MarketReplay.Infrastructure.Postgres;
...
builder.Services.AddSingleton<ITickCalculationPublisher, KafkaTickCalculationPublisher>();

builder.Services.AddHostedService<TickCalculationSignalRConsumer>();
builder.Services.AddHostedService<TickCalculationPersistenceConsumer>();
